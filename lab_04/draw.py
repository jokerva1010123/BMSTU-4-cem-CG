...
def draw_axes(canvas_win, xy_current, size):
    ...
    for i in range(0, s+1, s // 16):
        ...
        canvas_win.create_text(s // 2 - 20, i, text=f'{"%d" % xy_current[16 - j]}' if i - SIZE // 2 else '',
                               fill='grey', tag='coord', font="AvantGardeC 10")
